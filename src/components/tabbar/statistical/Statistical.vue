<template>
  <div class="statistical">
    ...
    <net-work v-if="chosedIndex === 0?true:false" @closeNetWork="closeNetWork"></net-work>
    <m-equipment v-if="chosedIndex === 1?true:false" @closeEquipment="closeNetWork"></m-equipment>
    <m-factory v-if="chosedIndex === 2?true:false" @closeFactory="closeNetWork"></m-factory>
    <m-valve v-if="chosedIndex === 3?true:false" @closeValve="closeNetWork"></m-valve>
    <m-node v-if="chosedIndex === 4?true:false" @closeNode="closeNetWork"></m-node>
  </div>
</template>
<script>
